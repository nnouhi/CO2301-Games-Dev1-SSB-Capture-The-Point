...
#include "LevelTwoGameMode.generated.h"

/**
 *
 */
UCLASS()
class ASSIGNMENTV1_API ALevelTwoGameMode : public ABaseGameMode
{
	GENERATED_BODY()
...
public:
	...
	// NN Get score of previous level
	int32 GetPreviousScore() override;
